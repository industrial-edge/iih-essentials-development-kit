function specData() {
    return {
        ...
        "info": {
            ...
            "description": "Description of the REST API of IIH Essentials. <br>The maximum size limit for a single request (no file) is 4 MB.<br>The connection timeout is 10 seconds.<br>The routes starting with \"/TokenManagerService/*\" are also available at port 4521.<br>This is deprecated and will be supported until 2023-09-07.",
            "version": "1.8.0"
        },
        "servers": [
            {
        ...
        "paths": {
            ...
            "/DataService/Data/Bulk/Read": {
                "post": {
                    ...
                    "description": "Bulk version of single variable read.",
                    "tags": [
                        "Data"
                    ],
                    "parameters": [
